...
2022.01.17 Roberto Puzzanghera - "jgreylist (v.8)" string in logs and smtp
  conversation changed to "greylist"
...
int main ( int argc , char *argv[] )
{
	...
	if ( JGREYLIST_LOG_PID )
		snprintf ( title , 31 , "greylist[%d]: " , getpid() ) ;
